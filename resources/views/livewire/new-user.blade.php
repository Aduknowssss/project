<div class="flex p-10 items-center flex-col">
    <h1 class="text-3x1 mb-2">User</h1>
    ...
    <form class="w-full max-w-lg">
        ...
        <button wireclick="submit" type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
    </form>
</div>
